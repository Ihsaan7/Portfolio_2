    ...
    <section className="py-16 md:py-20">
      ...
      <div className="space-y-12">
        {experiences.map((exp, expIndex) => (
          <div key={expIndex} className="space-y-6" data-testid={`experience-${expIndex}`}>
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 rounded-md overflow-hidden border border-border flex-shrink-0 bg-card">
                <img
            ...
            {exp.positions.map((position, posIndex) => (
              <div key={posIndex} className="ml-20 space-y-3" data-testid={`position-${expIndex}-${posIndex}`}>
                <div>
